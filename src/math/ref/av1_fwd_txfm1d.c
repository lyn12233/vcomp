...
/* modifications - waaaaard@qq.com 2026
 mimimum modifications to the includes and macros and debugs
 other contents are identical to [libaom]
*/
...
#define half_btf(w0, in0, w1, in1, bit) c1tx__half_btf(w0, in0, w1, in1, bit)
#define range_check_value(x, ...) (x)
#define sinpi_arr(bit) NULL
#define round_shift(value, bit) c1tx_round_shift(value, bit)
#define NewSqrt2 0
#define NewSqrt2Bits 12
#define av1_fdct4 static c1tx__av1_fdct4
#define av1_fdct8 static c1tx__av1_fdct8
#define av1_fdct16 static c1tx__av1_fdct16
#define av1_fdct32 static c1tx__av1_fdct32
#define av1_fdct64 static c1tx__av1_fdct64
#define av1_fadst4 static c1tx__av1_adst4
#define av1_fadst8 static c1tx__av1_adst8
#define av1_fadst16 static c1tx__av1_adst16
#define av1_fidentity4_c static c1tx__av1_iden4
#define av1_fidentity8_c static c1tx__av1_iden8
#define av1_fidentity16_c static c1tx__av1_iden16
#define av1_fidentity32_c static c1tx__av1_iden32
#define print_bf(str, bf, n)         \
    {                                \
        printf(str);                 \
        for (int i = 0; i < n; i++)  \
            printf("%08d, ", bf[i]); \
